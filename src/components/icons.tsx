...
export const ScalpelIcon: React.FC = () => (
    <IconWrapper>
        <svg xmlns="http://www.w3.org/2000/svg" className="transform -rotate-45" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M5.636 5.636a9 9 0 1012.728 0M12 3v9" />
            <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9 9 0 00-9-9h18a9 9 0 00-9 9z" />
        </svg>
    </IconWrapper>
);
